...
function getOurMissionContent() {
  return `
  <section>
    <div class="cover-img flex-div col-div white" style="text-align: center; background-image: linear-gradient(rgb(0 0 0 / 56%), rgb(0 0 0 / 62%)), url('assets/our-mission.webp');">
      <h1 class="heading">Our Mission</h1>
      <div class="apply-max-width" style="text-align: left; align-self: center;">
        ...
        <p style="margin-top: 20px;">Choose Day Night Packers And Movers for a hassle-free moving experience that you can trust.</p>
      </div>
    </div>
  </section>
  ${getChargesTableContent()}
...
function getOurTeamContent() {
  return `
  <section>
    <div class="cover-img flex-div col-div white" style="text-align: center; background-image: linear-gradient(rgb(0 0 0 / 56%), rgb(0 0 0 / 62%)), url('assets/our-team.webp');">      
...
function getOurServiceContent() {
  return `
  <section>
    <div class="cover-img flex-div col-div white" style="text-align: center; background-image: linear-gradient(rgb(0 0 0 / 56%), rgb(0 0 0 / 62%)), url('assets/our-services.webp');">
      <h1 class="heading">Our Service</h1>
      <div class="apply-max-width" style="text-align: left; align-self: center;">
        <p style="margin-bottom: 20px; margin-top: 30px;">At Day Night Packers And Movers, we offer a comprehensive range of moving services to cater to your specific needs:
        </p><br />
...
function getWhyChooseUsContent() {
  return `
  <section>
    <div class="cover-img flex-div col-div white" style="text-align: center; background-image: linear-gradient(rgb(0 0 0 / 56%), rgb(0 0 0 / 62%)), url('assets/why-choose-us.webp');">
      <h1 class="heading">Why Choose Us?</h1>
      <div class="apply-max-width" style="align-self: center; text-align: left;">
        <p style="margin-bottom: 5px; margin-top: 30px;">Choosing Day Night Packers And Movers means choosing a team of experienced movers, dedicated to providing exceptional service. Here are a few reasons why our customers trust us with their moves:</p><br /><br />
